...
namespace MyHealthApp.Services.Activities
{
    public class StepService
    {
        ...
        public async Task<HttpStatusCode> DeleteStepActivityByPatientId(long patientId, StepActivity stepRd)
        {
            _requestUri = new Uri($"https://myhealthnewapi.azurewebsites.net/api/step/{stepRd.Id.ToString()}");
